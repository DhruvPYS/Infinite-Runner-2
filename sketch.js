...
function preload(){
  ...
  desertImage = loadImage("assets/desert.png");
  shrub1 = loadImage("assets/shrub1.png");
  shrub2 = loadImage("assets/shrub2.png");
  shrub3 = loadImage("assets/shrub3.png");
 snake = loadImage("assets/snake3.png");
...
function setup() {
  ...
  desert = createSprite(400,100,400,20);
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
    ...
    var obstacle = createSprite(camera.position.x+400,350,40,40);
    obstacle.setCollider("rectangle",0,0,200,200)
    obstacle.addImage(snake);
